...
class GameServiceImplTest {
    ...
    fun setUp() {
        ...
        gameService = GameServiceImpl(scoreCardRepository, badgeCardRepository);

        // Common given - attempt does not contain a lucky number by default
        //val attempt = MultiplicationResultAttempt("john_doe", 20, 70, 1400, true)
    ...
    fun processCorrectAttemptForLuckyNumberBadgeTest() {
        ...
        val attempt = MultiplicationResultAttempt(
